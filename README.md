...
To change server settings, modify [conf.json](https://github.com/guyrotem/google-translate-server/blob/master/conf/config.json) (or .private) file(s).
Set "isProduction"=false to work with mock data (otherwise requests will be proxied to Google).
