...
Fortunately, I kept historical TKK values, so the service is working again (for now), using previously stored values.
However, I would no longer not recommend this solution for any purpose.
